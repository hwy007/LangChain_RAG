    ...
    <div className="flex flex-col h-full">
      ...
      <ScrollArea className="flex-1 p-3 overflow-y-auto" ref={scrollAreaRef}>
        <div className="space-y-3">
          {messages.length === 0 ? (
            <div className="text-center text-[#b36b00] mt-12">
              <Bot className="w-12 h-12 mx-auto mb-3 text-[#d48f00]" />
              <p className="text-base text-[#7a4b00]">欢迎使用RAG知识库问答系统</p>
              <p className="text-xs mt-1 text-[#b36b00]">请先在右侧上传文档，然后开始对话</p>
            </div>
          ) : (
            <>
